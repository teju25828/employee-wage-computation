...
public class Employee_Wage_Calculator {
    ...
    int full_Day = 8, part_Time = 4, wages_Per_Hour, wages_Per_Month = 0, present_Days = 0, absent_Days = 0, part_Time_Count = 0;
    ...
    public void display_Data() {
        ...
        System.out.println("Employee worked for part time   : " + part_Time_Count);
